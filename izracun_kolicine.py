...
def run():
    st.title("Aplikacija IZRAČUN KOLIČIN")
    st.write("V tej aplikaciji vnesete podatke o zaključni viskoznosti in masi ter viskoznsoti dveh surovin.")
    ...
    y1 = st.number_input("Vnesite Viskoznost surovine 1:", min_value=0, key="kolicina_y1", format="%d")
    y2 = st.number_input("Vnesite Viskoznost surovine 2:", min_value=0, key="kolicina_y2", format="%d")
